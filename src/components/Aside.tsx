...
const Aside = () => {
  ...
  return (
    <section className='w-[25%] bg-color1 h-[330vh] flex justify-start items-start relative'>
      <div className='flex justify-start items-start bg-color1 h-[100%] w-full '>
        <div className='flex justify-start w-full flex-col'>
          ...
          <div className='flex w-full justify-center'>
            <div className='p-3 flex gap-3 bg-color3 w-[90%] justify-items-center justify-center mt-[3rem] items-center rounded-md'>
              <div className='flex justify-center items-center flex-col w-full'>
                ...
                <Button text='Upgrade plan' style={{ padding: "12px", borderRadius: "10px", textAlign: "center", backgroundColor: "#590209", color: '#FFF4EA', fontSize: '15px', width: '100%' }} />
              </div>
            </div>
          </div>
